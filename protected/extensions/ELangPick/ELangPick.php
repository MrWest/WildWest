...
class ELangPick extends CPortlet
{
     ...
     */
    public $formStyle = 'margin:0; border: none; padding: 0; width: auto;margin-top:19px;';
    ...
    protected function renderContent()
    {
        ...
        switch ($this->pickerType)
        {
            ...
            case 'dropdown':
                ...
                echo CHtml::dropDownList('languagePicker' , Yii::app()->getLanguage(), $translationsU, array('submit'=>'', 'csrf'=>true,'onChange'=>"alertselected(this)",'type'=>"submit"));
                echo CHtml::endForm();
                break;
            case 'links':
                foreach ($translations as $trans)
